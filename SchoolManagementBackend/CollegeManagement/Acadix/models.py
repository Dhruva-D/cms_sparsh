...
class StudentRegistration(models.Model):
    ...
    mother_name = models.CharField(max_length=200, null=True, blank=False)
    mother_aadhaar_no = models.CharField(max_length=12,null=True,validators=[
    ...
    father_aadhaar_no = models.CharField(max_length=12, null=True,validators=[
        RegexValidator(regex=r'^\d{12}$', message='Aadhaar number must be exactly 12 digits.',
                       code='invalid_aadhaar_no'
                       )
    ])
    ...
    primary_guardian = models.CharField(max_length=255, default="FATHER", null=False, blank=False)
